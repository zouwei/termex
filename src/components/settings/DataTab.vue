...
<template>
  <div class="space-y-6">
    <!-- ── Recording ── -->
    <div class="space-y-3">
      <h3 class="text-sm font-medium" style="color: var(--tm-text-primary)">{{ t("recording.title") }}</h3>

      <!-- Retention period + cleanup on one row -->
      <div>
        ...
        <p class="text-xs mt-1.5" style="color: var(--tm-text-muted)">
    ...
    <!-- ── Backup ── -->
    <div class="space-y-3">
      <h3 class="text-sm font-medium" style="color: var(--tm-text-primary)">{{ t("backup.title") }}</h3>
